      ...
      {isOpen && (
        ...
        >
          ...
          <div className="max-w-md w-full mx-auto flex-1 flex flex-col gap-2 md:gap-4 min-h-0">
            <div className="grid grid-cols-3 grid-rows-3 gap-2 md:gap-4 flex-[3] min-h-0">
                ...
                <React.Fragment key={rowIndex}>
                  {row.map((num) => (
                    <button
                      ...
                      className="relative rounded-2xl bg-[#2d1b54] border-b-[4px] md:border-b-[6px] border-[#1c1134] shadow-[0_5px_15px_rgba(0,0,0,0.3)] hover:bg-[#3b2d71] active:border-b-0 active:translate-y-[4px] md:active:translate-y-[6px] transition-all flex items-center justify-center group overflow-hidden"
                    >
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-4 flex-1 min-h-0">
              <button
                onClick={onDelete}
                className="relative rounded-2xl bg-[#be123c] border-b-[4px] md:border-b-[6px] border-[#881337] shadow-[0_5px_15px_rgba(225,29,72,0.3)] hover:bg-[#e11d48] active:border-b-0 active:translate-y-[4px] md:active:translate-y-[6px] transition-all flex items-center justify-center group"
              >
              ...
              {status === 'incorrect' && onTryAgain ? (
                <button
                  onClick={onTryAgain}
                  className="relative rounded-2xl bg-orange-500 border-b-[4px] md:border-b-[6px] border-orange-700 shadow-[0_5px_15px_rgba(249,115,22,0.4)] hover:bg-orange-400 active:border-b-0 active:translate-y-[4px] md:active:translate-y-[6px] transition-all flex items-center justify-center group"
                >
                ...
                <button
                  ...
                  className={cn(
                    'relative rounded-2xl border-b-[4px] md:border-b-[6px] transition-all flex items-center justify-center group',
                    !checkDisabled
