        ...
        <div className="flex flex-col gap-3 pointer-events-auto bg-[#1a103c]/80 backdrop-blur-xl rounded-3xl p-4 border-[3px] border-[#3b2d71] shadow-xl">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex-1 flex flex-col items-center text-center px-1">
              <p className="text-[#a78bfa] text-[10px] md:text-xs font-black uppercase tracking-[0.2em] mb-0.5 shadow-sm">
                Level
              </p>
            ...
            <div className="w-14 h-14 rounded-full border-[3px] border-amber-400 overflow-hidden shadow-lg bg-[#2d1b54] flex-shrink-0 relative">
              <ImageWithFallback
                src={
                  ...
                  "https://images.unsplash.com/photo-1561229474-1f22e022dfd4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdXRlJTIwY2FydG9vbiUyMGF2YXRhciUyMGtpZCUyMDNkfGVufDF8fHx8MTc3NDE4OTA4MHww&ixlib=rb-4.1.0&q=80&w=1080"
                }
                alt="Avatar"
            ...
            >
              ...
              >
                ...
                <div className="absolute -bottom-2 -right-2 w-8 h-8 md:w-10 md:h-10 rounded-full border-[3px] border-white flex items-center justify-center shadow-lg bg-[#2d1b54] z-20">
                  {cp.status === "completed" && (
                    <Check className="w-5 h-5 md:w-6 md:h-6 text-emerald-400" strokeWidth={4} />
                  )}
